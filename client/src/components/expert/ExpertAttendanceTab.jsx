...
export default function ExpertAttendanceTab({ user }) {
  ...
  return (
    <div className="flex flex-col h-full animate-fade-in space-y-6 w-full">
      {/* Attendance Header */}
      <div className="bg-primary/5 border border-primary/20 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
        <div>
          <h2 className="text-4xl font-black text-primary mb-2">My Attendance</h2>
          <p className="text-secondary text-sm">
            This count represents the total number of unique days you have successfully reported an event.
          </p>
        </div>
        <div className="shrink-0 flex items-center justify-center bg-white shadow-xl rounded-2xl p-6 min-w-[200px] border border-outline/10">
      ...
      {/* Filters & Export */}
      <div className="bg-white border border-outline/10 rounded-2xl p-4 flex flex-col md:flex-row gap-4 shadow-sm items-end">
      ...
      {/* Sheets Form (Table) */}
      <div className="flex-grow bg-white border border-outline/10 rounded-2xl overflow-hidden flex flex-col min-h-[400px] shadow-sm">
